...
public class ProductInfoAllDto {
	...
	private BigDecimal discountPrice; // Giá sau sale
	...
	public ProductInfoAllDto() {
		super();
		// TODO Auto-generated constructor stub
	}

	public ProductInfoAllDto(String productId, String sku, String name, String origin, ProductCondition condition,
			String warrantyPeriod, BigDecimal price, Gender gender, Segment segment, String description,
			String discountType, BigDecimal discountValue, BigDecimal discountPrice, String brandName, String typeName,
			String caseMaterialName, String strapMaterialName, String glassMaterialName, LocalDateTime createdAt,
			LocalDateTime updatedAt, List<ImageDTO> images) {
		super();
